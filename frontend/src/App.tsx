  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-4 py-8">
      <header className="w-full max-w-3xl mb-8">
        <h1 className="text-2xl font-bold mb-1">InsightGuard playground UI</h1>
        <p className="text-sm text-slate-400">
          Simple React + shadcn-style interface to test your FastAPI + Neo4j
          stack.
        </p>
      </header>

      <main className="w-full max-w-3xl grid gap-6 md:grid-cols-2">
        <Card>
