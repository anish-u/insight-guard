...
const MonthlyDhsWebPage: React.FC = () => {
  const now = new Date();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/ingest/monthly-dhs-web`, {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Monthly DHS Web Application Report</CardTitle>
        </CardHeader>
        <CardContent>
...
export default MonthlyDhsWebPage;
